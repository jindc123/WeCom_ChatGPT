# https://www.dandelioncloud.cn/article/details/1518062686087802882
...
class Prpcrypt(object):
    ...
    def decrypt(self, text, receiveid):
        ...
        try:
            ...
            plain_text = cryptor.decrypt(base64.b64decode(text))  # python3
        except Exception as e:
            print(e)
        ...
        try:
            ...
            content = plain_text[16:]  # 去掉前16随机字节
            msg_len = socket.ntohl(struct.unpack("I", content[: 4])[0])  # 取出4字节的msg_len
            xml_content = content[4:msg_len + 4]  # 截取msg_len 长度的msg
            from_receiveid = content[msg_len + 4:]  # 剩余字节为receiveid
        except Exception as e:
            print(e)
            return ierror.WXBizMsgCrypt_IllegalBuffer, None
        if receiveid not in from_receiveid.decode():
